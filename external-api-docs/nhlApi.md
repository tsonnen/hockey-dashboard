...
```json
{
  ...
  "standingsDateTimeUtc": "2026-02-16T04:57:30Z",
  "standings": [
    {
      "conferenceAbbrev": "W",
...
```json
{
  ...
  "defensemen": [
    {
      "id": 8479325,
      "headshot": "https://assets.nhle.com/mugs/nhl/20252026/TOR/8479325.png",
      "firstName": { "default": "Mikhail" },
      "lastName": { "default": "Sergachev" },
      "sweaterNumber": 98,
      "positionCode": "D"
    }
  ],
  "goalies": [
    {
      "id": 8482821,
      "headshot": "https://assets.nhle.com/mugs/nhl/20252026/TOR/8482821.png",
  ...
  "games": [
    {
      ...
      "tvBroadcasts": [{ "id": 284, "market": "N", "countryCode": "CA", "network": "SN1" }],
      "gameState": "OFF",
      ...
      "games": [
        {
          ...
          "gameType": 9,
          "gameDate": "2026-02-12",
          "startTimeUTC": "2026-02-12T11:00:00Z",
          "gameState": "FINAL",
          "awayTeam": {
            "id": 6776,
            "name": { "default": "Switzerland" },
            "abbrev": "SUI",
            "score": 4,
            "logo": "https://assets.nhle.com/logos/ntl/svg/SUI_light.svg"
          },
          "homeTeam": {
            "id": 7228,
            "name": { "default": "France" },
            "abbrev": "FRA",
            "score": 0,
            "logo": "https://assets.nhle.com/logos/ntl/svg/FRA_light.svg"
          },
...
```json
{
  ...
  "venue": { "default": "KeyBank Center" },
  "gameState": "FINAL",
  "homeTeam": { "abbrev": "BUF", "score": 2 },
  "awayTeam": { "abbrev": "MIN", "score": 3 }
}
```
...
_For the full WADL with extended resources: [WADL Link](https://api-web.nhle.com/application.wadl?detail=true)_
...
- **Parameters**:
  - `sort-by` (str) - String - **TODO**
    - 'shots' - Shots on Goal
    - _Likely more parameters available_
  - `season` (int) - Season in YYYYYYYY format
  - `game-type` (int) - 2 for regular season, 3 for postseason
- **Response**: JSON format
...
_For the full WADL with extended resources: [WADL Link](https://api.nhle.com/stats/rest/application.wadl?detail=true)_
